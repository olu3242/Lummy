...
import { createStripeCheckoutSession } from '../../../src/lib/payments/stripe/provider'
...
export class StripeProvider implements PaymentProviderInterface {
  async initializePayment(input: InitializePaymentInput): Promise<ProviderInitializeResult> {
    ...
    return { providerReference: res.providerReference, checkoutUrl: res.checkoutUrl, status: 'initiated', raw: { provider: 'stripe' } }
  }
