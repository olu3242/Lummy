...
import { Star, MessageSquare, TrendingUp, ThumbsUp, Search, ChevronDown } from "lucide-react"
import { cn } from "@/lib/utils"

const mockReviews = [
  { id: "R1", customer: "Amaka O.", product: "Ankara Peplum Top", rating: 5, comment: "Absolutely love this! The fabric quality is amazing and it fits perfectly. Will definitely order again.", date: "May 3, 2026", verified: true, helpful: 12 },
  { id: "R2", customer: "Chidi N.", product: "Men's Agbada Set", rating: 5, comment: "Very professional packaging and the material is top notch. Got so many compliments at the event!", date: "Apr 29, 2026", verified: true, helpful: 8 },
  { id: "R3", customer: "Funmi A.", product: "Lace Iro & Buba", rating: 4, comment: "Beautiful design, delivery was a bit slow but the quality made up for it. Highly recommended.", date: "Apr 22, 2026", verified: true, helpful: 5 },
  { id: "R4", customer: "Tunde B.", product: "Dashiki Shirt", rating: 5, comment: "Perfect fit and the colors are vibrant. Customer service was excellent when I had a size question.", date: "Apr 18, 2026", verified: true, helpful: 7 },
  { id: "R5", customer: "Ngozi M.", product: "Adire Gown", rating: 3, comment: "Nice fabric but the stitching on one side wasn't clean. Seller resolved it quickly though.", date: "Apr 10, 2026", verified: true, helpful: 2 },
  { id: "R6", customer: "Emeka I.", product: "Aso-Oke Fila", rating: 5, comment: "Excellent quality! This is my third order from this store. Never disappointed.", date: "Apr 5, 2026", verified: true, helpful: 14 },
]
      ...
      <div className="space-y-3">
        {filtered.length === 0 ? (
          ...
          <motion.div key={review.id} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
            ...
            <p className="text-xs text-muted-foreground leading-relaxed mb-2">&ldquo;{review.comment}&rdquo;</p>
