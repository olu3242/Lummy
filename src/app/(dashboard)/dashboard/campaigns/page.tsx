...
const mockCampaigns: Campaign[] = [
  {
    ...
    ctaUrl: "lummy.co/sade.styles?utm_campaign=mothers-day",
  ...
  },
  {
    ...
    ctaUrl: "lummy.co/sade.styles/new-arrivals",
  ...
  },
  {
    ...
    ctaUrl: "lummy.co/sade.styles/leather-bag",
    audience: "All customers",
  ...
  },
  {
    ...
    reach: 0, clicks: 0, orders: 0, revenue: 0,
    ctaUrl: "lummy.co/sade.styles/summer",
    audience: "All customers",
  },
]
  ...
  const handleSave = (asDraft?: boolean) => {
    ...
    setTimeout(() => {
      const newCampaign: Campaign = {
        ...
        ctaUrl: `lummy.co/sade.styles?utm_campaign=${form.name.toLowerCase().replace(/\s+/g, "-")}`,
